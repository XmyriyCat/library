    ...
    public class InitialDataStorage
    {
        ...
        private List<Book> GenerateBooks()
        {
            var books = new List<Book>()
            {
                new Book()
                {
                    Id = Guid.Parse("a94571e1-7150-490b-bd4b-909e06d39d33"),
                ...
                new Book()
                {
                    Id = Guid.Parse("056527af-0a82-4b4b-99f8-7f3ac7b0f0be"),
                ...
                new Book()
                {
                    Id = Guid.Parse("4f2f47f2-4beb-479d-9255-d449165fdbee"),
                ...
                new Book()
                {
                    Id = Guid.Parse("705452a0-2d44-48d6-936d-22f6ea11a747"),
                ...
                new Book()
                {
                    Id = Guid.Parse("eb5b64b7-ed91-4454-8124-def388dcb60b"),
                ...
                new Book()
                {
                    Id = Guid.Parse("f3967bfa-c178-4d88-873d-866d34176aa4"),
                ...
                new Book()
                {
                    Id = Guid.Parse("d9676151-46c1-4a64-967f-c96b05be752a"),
